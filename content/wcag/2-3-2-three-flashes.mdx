...
Review how your components meet **2.3.2 Three Flashes** when authoring UI. Use semantic HTML, ARIA only when necessary, and test with keyboard and screen readers.
...
- [Understanding 2.3.2](https://www.w3.org/WAI/WCAG22/Understanding/232.html)
- [WCAG quick reference](https://www.w3.org/WAI/WCAG22/quickref/#232)
