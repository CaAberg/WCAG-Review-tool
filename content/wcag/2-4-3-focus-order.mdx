...
Review how your components meet **2.4.3 Focus Order** when authoring UI. Use semantic HTML, ARIA only when necessary, and test with keyboard and screen readers.
...
- [Understanding 2.4.3](https://www.w3.org/WAI/WCAG22/Understanding/243.html)
- [WCAG quick reference](https://www.w3.org/WAI/WCAG22/quickref/#243)
