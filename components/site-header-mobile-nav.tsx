  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent
          id={menuId}
          className="left-auto max-h-full top-0 h-full max-w-xs translate-x-0 translate-y-0 overflow-y-auto overscroll-contain p-4 data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right fixed right-0 sm:rounded-none sm:p-6"
        >
          ...
          <nav aria-label="Main navigation">
            <ul className="flex flex-col gap-1">
              <li>
                <Link
                  href="/component-analyzer"
                  className={navLinkClassName}
                  aria-label="Component Analyzer"
